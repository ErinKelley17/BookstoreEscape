...
public class FirstPersonController : MonoBehaviour
{
    ...
    public void initSpeedBoostOnly ()
    {
//        useSprintBar = false;
//        unlimitedSprint = false;
    ...
    public void restoreSprintKey ()
    {
        sprintKey = KeyCode.LeftShift;
    }

    public void speedBoost (bool setSprint, float multiplier = 1.5f, float duration = 5.0f)
    {
//        if (!isSprinting && setSprint)
        if (setSprint)
        {
            enableSprint = setSprint;
            isSprinting = setSprint;

            sprintDuration = duration;
            sprintRemaining = duration;
            sprintSpeed = walkSpeed * multiplier;
//            Debug.LogWarning ("Starting sprint");
        }
        else if (isSprinting && !setSprint)
        {
            enableSprint = setSprint;
            isSprinting = setSprint;
//            Debug.LogWarning ("Stopping sprint");
        }
...
//            Debug.Log ("enableSprint = " + enableSprint + ";  sprintKey = " + sprintKey
//                    + ";  isSprinting = " + isSprinting + ";  sprintRemaining = " + sprintRemaining
//                    + ";  isSprintCooldown = " + isSprintCooldown);

//            print ("Input.GetKey (sprintKey) = " + Input.GetKey (sprintKey));

            // All movement calculations while sprint is active
            if (enableSprint && (Input.GetKey(sprintKey) || (sprintKey == KeyCode.None && isSprinting)) && sprintRemaining > 0f && !isSprintCooldown)
            {
